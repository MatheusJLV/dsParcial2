...
public class Screen_DataUsuarios {
    ...
    public Screen_DataUsuarios(Connection con,String query,ObservableList rowList, int add0,String Updatequery) {
        ...
        bt.setOnAction(e->{
            ...
            try {
                if(this.add0==1){
                                    ExecuteQuery("UPDATE Usuario SET nombre=\""+t2.getText()+"\", telefono="+t3.getText()+"\", direccion= \""+t4.getText()+"\", mail= \""+t5.getText()+"\", username= \""+t6.getText()+"\", userpassword= \""+t7.getText()+"\", cargo= \""+t8.getText()+" WHERE id="+t1.getText());
